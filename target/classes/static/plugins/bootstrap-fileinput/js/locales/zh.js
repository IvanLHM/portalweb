 ...
 *
 * This file must be loaded after 'fileinput.min.js'. Patterns in braces '{}', or
...
(function (factory) {
    ...
    $.fn.fileinputLocales['zh'] = {
        ...
        msgDuplicateFile: '文件 "{name}" 已经被选择，跳过重复的文件。',
        msgResumableUploadRetriesExceeded:  '上传已取消，超过重试次数 <b>{max}</b>! 错误详情: <pre>{error}</pre>',
